    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerBackpacks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ArmorTypes = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayerBackpackId = table.Column<int>(type: "int", nullable: false),
                    TypeOfArmorId = table.Column<int>(type: "int", nullable: false),
                    ItemLvl = table.Column<int>(type: "int", nullable: false),
                    Concentration = table.Column<int>(type: "int", nullable: false),
                    NumberOfSockets = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    Rarity = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FullArmors", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FullArmors_TypeOfArmors_TypeOfArmorId",
                        column: x => x.TypeOfArmorId,
                        principalTable: "TypeOfArmors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullArmorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Resistances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Resistances_FullArmors_FullArmorId",
                        column: x => x.FullArmorId,
                        principalTable: "FullArmors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FullArmors_PlayerBackpackId",
                table: "FullArmors",
                column: "PlayerBackpackId");

            migrationBuilder.CreateIndex(
                name: "IX_FullArmors_TypeOfArmorId",
                table: "FullArmors",
                column: "TypeOfArmorId");

            migrationBuilder.CreateIndex(
                name: "IX_Resistances_FullArmorId",
                table: "Resistances",
                column: "FullArmorId");
        }
